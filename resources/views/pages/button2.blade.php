...
<div class="box-1">
    <div class="btn btn-one">
        <a style="color: #000;" href="/about"><span>See More</span></a>
    </div>
  </div> --}}
...
<div class="wrapper m-2 p-2">
    <a class="cta" href="/career" style="text-decoration: none; color:#fff">
