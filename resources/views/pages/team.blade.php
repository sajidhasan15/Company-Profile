    ...
    <body id="page-top">
        ...
        <script>
            ...
            {{-- <div class="text-center">
                <p class="text-center text-white font-bold" style="padding-top: 5%; font-size: 80px; font-weight: 900">Team</p>
                <a href="#team"><i class="fa-solid fa-chevron-down fa-2x" style="color: #fff; padding-bottom: 5%"></i></a>
            </div> --}}
            <!-- ======= Team Section ======= -->
              ...
              <div class="px-2 col-lg-6">
                <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                  ...
                  <div class="member-info">
                    ...
                    <div class="social">
                      <a href=""><i class="fa-brands fa-twitter" style="color: #37517E"></i></a>
                      <a href=""><i class="fa-brands fa-facebook" style="color: #37517E"></i></a>
                      <a href=""><i class="fa-brands fa-instagram" style="color: #37517E"></i></a>
                      <a href=""> <i class="fa-brands fa-linkedin" style="color: #37517E"></i> </a>
                    </div>
                  </div>
                </div>
              </div>

              <div class="px-2 col-lg-6 mt-4 mt-lg-0">
